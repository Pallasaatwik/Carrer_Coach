...
const HeroSection = () => {
  ...
  return (
  <section className="w-full pt-36 md:pt-48 pb-40">
    <div className="space-y-6 text-center">
      ...
      <div className="hero-image-wrapper mt-5 md:mt-0">
        <div ref={imageRef} className="hero-image">
          <Image src="/banner2.jpeg" width={1280} height={720} alt="Banner Sensai" className="rounded-lg shadow-2xl border mx-auto" priority/>
        </div>
      </div>
    </div>
  </section>
...
//   return (
//     <section className="w-full pt-36 md:pt-48 pb-40 md:pb-64 lg:pb-96 min-h-screen flex flex-col justify-center">
//       <div className="space-y-6 text-center">
//         <div className="space-y-6 mx-auto">
...
//               height={720} 
//               alt="Banner Sensai" 
//               className="rounded-lg shadow-2xl border mx-auto transform transition-all duration-500" 
//               priority
//             />
//           </div>
//         </div>
